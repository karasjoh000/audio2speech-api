...
try { 
	const config = yaml.safeLoad(fs.readFileSync('/home/ixti/example.yml', 'utf8'));
	DEEPSPEECH_MODEL = config["prod"]["path"]; 
	console.log(DEEPSPEECH_MODEL)
} catch (e) { 
	console.log(e);
	console.log("please update config.yaml for pre-trained model path") 
	process.exit(1); 
}
